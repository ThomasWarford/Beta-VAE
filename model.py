...
class BetaVAE_H_128(BetaVAE_H):
    """Model proposed in original beta-VAE paper(Higgins et al, ICLR, 2017) with additional layer to take size-128 images"""
